...

{
...

    {
        ...
        if ($id_pesan_ulang2 != null) {
            ...
            //$data['surat_jalan'] = $this->surat_jalan_m->TampilData()->result();

            /*$data['pesan_ulang'] = $this->db->get_where('pesan_ulang', ['STATUS_PESAN_ULANG' => 0])->result();*/
