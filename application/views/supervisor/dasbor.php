        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <!-- <div class="text-right">
                    <form action="<?php echo base_url('laporan/sales_cetak') ?>" method="POST" name="add_name" target="_BLANK">
                    <button class="btn btn-info mr-1" type="submit">Cetak Laporan Penjualan Sales</button>
                    </form>
                </div> -->
            </div>
...
Highcharts.chart('container', {
    ...
    title: {
        ...
        text: 'Perkembangan Sales Terbaik Tahun <?php echo $year;?>'
...

    {
        ...
        $tgl = $bln[$i].'-'.$year;
			...
			WHERE pg.ID_PENGGUNA = '$idpg' AND DATE_FORMAT(p.TGL_PENJUALAN, '%m-%Y') = '$tgl'

			GROUP BY p.ID_PENGGUNA

            ORDER BY SUM(p.JUMLAH_PENJUALAN) DESC")->num_rows();
